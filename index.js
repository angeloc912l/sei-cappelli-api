...
const intenzioni = {
  ...
  valutazione: {
    ...
    cappelli: {
      ...
      giallo: "Quando indossi il cappello giallo fornisci la lista di al massimo 5 punti: per sviluppare ogni punto devi essere positivo e costruttivo, devi cercare e valutare guadagni e benefici e poi devi cercare una base logica su cui fondarli. Offri inoltre suggerimenti, proposte, opportunità concrete ed efficienti.",
